...
function PageEmploi() {
  ...
  const CRENEAUX_MATIN = ['07H-08H','08H-09H','09H-10H','10H-11H','11H-12H','12H-13H']
  const CRENEAUX_APREM = ['13H-14H','14H-15H','15H-16H','16H-17H','17H-18H']
  ...
  const renderInput = (creneau: string) => {
    const [debut, fin] = creneau.split('-')
    const h = (t: string) => t.replace('H','')
      ...
      {onglet === 'saisie' && (
        <div className="bg-white rounded-xl shadow p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              <p className="text-xs font-bold text-orange-600 mb-2">🌇 Après-midi (13H - 18H)</p>
              {CRENEAUX_APREM.map(c => renderInput(c))}
            </div>
          </div>
    ...
    <div className="max-w-2xl mx-auto space-y-4">
      {etape === 'accueil' && (
        <div className="bg-white rounded-xl shadow p-6">
          ...
          <p className="text-gray-500 mb-6">Préparez la salle informatique pour la nouvelle année scolaire.</p>
          ...
          <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-4 mb-6">
            <p className="text-yellow-800 font-medium">⚠️ Attention : Cette action est irréversible.</p>
          </div>
      ...
      {etape === 'done' && (
        <div className="bg-white rounded-xl shadow p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">La salle est prête pour la nouvelle année scolaire.</p>
